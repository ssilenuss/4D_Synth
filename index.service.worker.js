...
/** @type {string} */
const CACHE_VERSION = '1768947661|1334397877';
/** @type {string} */
const CACHE_PREFIX = 'Gynth-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libgdgynth.web.template_release.wasm32.wasm"];
